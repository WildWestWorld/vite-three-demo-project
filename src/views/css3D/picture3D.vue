...
const initCamera = () => {
  ...
  toRaw(camera.value).position.z = 5.5;
...
const initCube = () => {
  ...
  //   let texture = textureLoader.load('./files/img/build/build.jpg');
  //   let depthTexture = textureLoader.load('./files/img/build/build_depth.jpg');

  let texture = textureLoader.load('./files/img/cat/cat.jpg');
  let depthTexture = textureLoader.load('./files/img/cat/cat_depth.jpg');
  ...
  `,
    ...
    void main() {
      ...
      float x = vUv.x + (uMouse.x+sin(uTime))*0.003*depthValue;
      float y = vUv.y + (uMouse.y+cos(uTime))*0.003*depthValue;
