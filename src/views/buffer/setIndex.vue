...
import { normalizeStyle, onMounted, reactive, ref, toRaw } from 'vue';
// 变量区
//白光
let dirLight;
...
const initCamera = () => {
  ...
  toRaw(camera.value).position.z = 64;
...
const initCube = () => {
  ...
  // position =>index=>faces(三角形)=>mesh(网格)
...
const render = () => {
  ...
  cube.value.rotation.y = time * 0.25;
