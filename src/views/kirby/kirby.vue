<template>
  <div class="container">
    <div class="background">
      ...
      <div class="text">MADE BY</div>
      <div class="text">Wild</div>
      <div class="text">West</div>
      <div class="text">World</div>
      <div class="small-text">©2023</div>
    </div>
...
const initCube = () => {
  ...
  // 加载hdr
  new RGBELoader().load('./files/hdr/kiara_1_dawn_1k.hdr', function (texture) {
  ...
  gltfLoader.load('./files/gltf/kirby.glb', (gltf) => {
    kirby = gltf.scene;
    kirby.name = 'kirby';
    scene.value.add(kirby);
  });
};
//初始化圆柱体
const initCylinder = () => {
...
const render = () => {
  ...
  if (kirby) {
    kirby.rotation.y = kirby.rotation.y + 0.01;
  }
